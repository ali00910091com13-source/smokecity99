...
export default function CheckoutPage() {
  ...
  const handleGoogleLogin = () => {
    ...
    const mockUser = {
      ...
      name: 'کاربر اسموک سیتی',
      avatar: 'https://ui-avatars.com/api/?name=User&background=00C07F&color=fff',
      isLoggedIn: true,
    };
          ...
          {currentStep === 1 && (
            <div className="text-center py-8">
              ...
              <button
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-white border-2 border-gray-200 rounded-xl hover:border-[#00C07F] hover:shadow-lg transition-all"
              >
                ...
                <span className="text-[#1a1a2e] font-medium">ورود با گوگل</span>
              </button>
            </div>
          )}
