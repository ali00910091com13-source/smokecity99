      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
          ...
          <div className="mt-6 text-center">
            <button onClick={() => navigate('/')} className="text-sm text-gray-500 hover:text-[#00C07F] transition-colors">
              بازگشت به سایت
            </button>
          </div>
        </div>
        ...
        {activeTab === 'dashboard' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { label: 'درآمد کل', value: `${(dbOrders.reduce((sum, order) => sum + (order.total || 0), 0) / 10000).toFixed(0)}K`, icon: 'dollar-sign', color: 'orange' },
            ].map((stat, i) => (
        ...
        {activeTab === 'products' && (
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b flex items-center justify-between">
              ...
              <button onClick={handleAddProduct} className="btn-accent px-6 py-2 rounded-xl">
        ...
        {activeTab === 'blog' && (
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b flex items-center justify-between">
              ...
              <button onClick={handleAddBlogPost} className="btn-accent px-6 py-2 rounded-xl">
